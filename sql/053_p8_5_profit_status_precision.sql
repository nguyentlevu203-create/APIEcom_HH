-- =====================================================================
-- 053_p8_5_profit_status_precision.sql
-- P8.5 "FINAL FINISH" Section 7 — precise Profit status. Body identical
-- to sql/051 except one existing column's expression: profit_status now
-- says MISSING_BACKOFFICE_SOURCE (the true, only blocker: backoffice_cost
-- is a hardcoded NULL with no source anywhere in the pipeline) instead
-- of the vaguer RULE_NOT_APPROVED, whenever cm2 itself is known. profit
-- itself remains NULL — never fabricated, no EBITDA substitute.
-- =====================================================================
-- =====================================================================
